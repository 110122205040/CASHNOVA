  ...
  return (
    <header className="theme-topbar sticky top-0 z-30 mx-3 mt-3 flex flex-wrap items-center justify-between gap-3 rounded-[24px] px-4 py-3 backdrop-blur sm:mx-4 sm:px-5 lg:mx-4 lg:px-5 xl:mx-5 xl:px-6">
      ...
      <div className="ml-auto flex items-center gap-3 sm:gap-4">
        <div className="theme-input hidden items-center rounded-2xl px-4 py-2.5 sm:flex sm:w-[250px] lg:w-[280px] xl:w-[320px]">
          <input
            type="text"
            placeholder="Search..."
            className="w-full bg-transparent text-sm font-medium text-[#355465] outline-none placeholder:text-[#7790a0]"
          />
          <Search size={18} className="text-[#1f5f7a]" />
        </div>
      ...
      <div className="theme-input flex w-full items-center rounded-2xl px-4 py-3 sm:hidden">
          <input
          type="text"
          placeholder="Search..."
