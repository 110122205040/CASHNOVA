        ...
        <div className="relative">
          ...
          >
            {sessionUser?.avatarUrl ? (
              <img src={sessionUser.avatarUrl} alt={profileName} className="h-full w-full rounded-full object-cover" />
            ) : (
              <span className="text-sm font-bold">{profileInitials}</span>
            )}
          </div>
              ...
              <form onSubmit={handleProfileSubmit} className="space-y-3">
                <div className="flex flex-col items-center gap-2 border-b border-[rgba(98,125,141,0.16)] pb-3">
                  <div className="relative">
                    ...
                    >
                      {pendingAvatarUrl || sessionUser?.avatarUrl ? (
                        <img
                          src={pendingAvatarUrl || sessionUser.avatarUrl}
                          alt={profileName}
                          className="h-full w-full object-cover"
                        />
                      ) : (
                        <span className="text-lg font-bold">{profileInitials}</span>
                      )}
                    </button>
                    <button
                      type="button"
